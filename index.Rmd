...
#### **Homework**
Each week you will be asked to complete and submit three assignments: Reading quizzes, in-class activities, and homework. Weekly homework assignments will be due before class in order to assess understanding and content mastery. Students are encouraged to work together on homework assignments, but each student must hand in their own work. Late homework is accepted for one week after the original due date and scored using a 50% penalty.
