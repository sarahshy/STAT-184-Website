...
## Office hours (still working on this)
| Time         | Location      | Who         |
| ------------ |:-------------:| -----------:|
...
#### **Homework**
Weekly homework assignments will be due the night before class (11:59 PM) in order to assess understanding and content mastery. Students are encouraged to work together on homework assignments, but each student must hand in their own work. Late homework is accepted for one week after the original due date and scored using a 50% penalty.
